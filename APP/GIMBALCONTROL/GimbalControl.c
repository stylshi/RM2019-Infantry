...
#ifdef INFANTRY_2
float Pitch_AutoAim_pp=35.0;
float Pitch_AutoAim_pi=130.0;
float Pitch_AutoAim_pd=2.05;
float Pitch_AutoAim_sp=35.0;
float Pitch_AutoAim_si=0.0;
float Pitch_AutoAim_sd=13.0;
#endif
#ifdef INFANTRY_1
float Pitch_AutoAim_pp=60.0;
float Pitch_AutoAim_pi=5.0;
float Pitch_AutoAim_pd=1.5;
float Pitch_AutoAim_sp=50.0;
float Pitch_AutoAim_si=0.0;
float Pitch_AutoAim_sd=13.0;
#endif
#ifdef INFANTRY_3
float Pitch_AutoAim_pp=100.0;
float Pitch_AutoAim_pi=150.0;
float Pitch_AutoAim_pd=3.2;
float Pitch_AutoAim_sp=50.0;
float Pitch_AutoAim_si=0.0;
float Pitch_AutoAim_sd=13.0;
#endif
...
#ifdef INFANTRY_1
float Yaw_BIGBUFF_pp=120.0;//130 63
float Yaw_BIGBUFF_pi=180.0;//58.0 70.0       5.0
...
#ifdef INFANTRY_2
		PID_ControllerInit(&PitchPID_AIM.Position,500,20000,60000,0.001);
...
void TargetCacul(void)
{
    ...
    else if(remoteState==KEY_REMOTE_STATE)
    {
        ...
        {
            float pit_temp;
          if((RC_Ex_Ctl.key.v & KEY_PRESSED_OFFSET_F )==KEY_PRESSED_OFFSET_F)
					{
						;
					}
					else
