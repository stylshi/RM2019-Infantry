...
float test_p = 0.7,test_i = 0.2,test_d = 0.033,test_limit=200;   //调PID用
...
//	u8 temp_uartbuf;
////	printf("Receive: %c \r\n",usart1_rxbuf);
//	temp_uartbuf = USART_RX_BUF2[0];
//	USART_RX_BUF2[0] = 0;
//	switch(temp_uartbuf)
//	{
//		case 'q':test_p += 0.05;break;
//		case 'w':test_i += 0.02f;break;
//		case 'e':test_d += 0.005f;break;
//		case 'r':test_limit += 5;break;
//		case 'a':test_p -= 0.05;break;
//		case 's':test_i -= 0.02f;break;
//		case 'd':test_d -= 0.005f;break;
